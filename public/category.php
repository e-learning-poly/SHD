      ...
      <div class="row">
        <div class="col-md-3 mt-4 ml-4">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">2D +Animation</a>
            </li>

            <li class="nav-item">
              <a href="#" class="nav-link">Audio + Music</a>
            </li>

            <li class="nav-item">
              <a href="#" class="nav-link">Bussiness</a>
            </li>
        ...
        <div class="col-md-8 mt-4">
                   ...
                   <a href="">
                      <div class="card">
                        <div class="box-img">
                          ...
                          <img src="images/dev-4.jpg" class="img-fluid">
                        </div>
          ...
          <div class="container p-0 el-background-category el-shadow rounded  list-category mt-5 mb-4">
            <div class="container-fluid">
              <div class="row p-4">
                <p class="font-weight-bold mr-2">300 <span class="font-weight-normal"> khóa học </span> </p>
                 <p class="font-weight-bold"> 12.500 <span class="font-weight-normal"> videos </span></p>
              </div>
              ...
              <!--box category-->
                <div class="row p-4 list-category el-border">
                    ...
                    <div class="col-md-8 pl-5">
                      <p class="font-weight-bold m-0 p-0">Dựng video chuyên nghiệp với Adobe Preview</p>
                      <p>Triêu Đình Nam</p>
                      <p class="mt-5 pull-left">499.000<sup>đ</sup> </p>

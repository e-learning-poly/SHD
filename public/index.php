                    ...
                    <div class="col-md-5 push-md-6">
                        <form action="" method="POST" id="form-register" class="form-register wow fadeInRight animated" data-wow-delay=".25s">
                            ...
                            <div class="info-register">
                                ...
                                <div class="wrap-btn">
                                    <a class="flat-btn-or text-uppercase" href="#">nhận mã</a>
                                </div>
                            </div> 
                        </form>
                    </div><!-- col-md-5 -->
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-lg-6 box-card mb-3">
					<div class="el-software el-thumbnail">
								<a href="" class="box-click text-white">
									<div class="box-img">
										<div class="image-column text-center"> 
											<div class="text-details">
												<h3>Ứng dụng phần mềm</h3>
				...
				<div class="col-sm-12 col-lg-6">
					<div class="row">
						<div class="col-sm-6 mb-3 box-card">
							<div class="el-design el-thumbnail">
						...
						<div class="col-sm-6 box-card">
							<div class="el-business el-thumbnail">
								<div class="box-click text-white">
									<div class="box-img">
										<div class="image-column text-center">
											<div class="text-details">
					...
					<div class="row mt-3">
						<div class="col-sm-6 mb-3 box-card">
							<div class="el-web el-thumbnail">
								<div class="box-click text-white">
									<div class="box-img">
										<div class="image-column text-center">
											<div class="text-details">
												<h3>Lập trình website</h3>
												<h4>Hơn 650 khóa học</h4>
												<button type="button" class="btn Preview btn-md text-white">
													<h4><i class="fa fa-play-circle-o"></i> Xem các khóa học</h4>
												</button>
						...
						<div class="col-sm-6 mb-3 box-card">
							<div class="el-photography el-thumbnail">
								<div class="box-click text-white">
									<div class="box-img">
										<div class="image-column text-center">
											<div class="text-details">
												<h3>Đồ họa &amp; hình ảnh</h3>
												<h4>Hơn 250 khóa học</h4>
												<button type="button" class="btn Preview btn-md text-white">
													<h4><i class="fa fa-play-circle-o"></i> Xem các khóa học</h4>
												</button>
		...
		<div class="container pt-5 pb-5">
			...
			<div class="row mt-2">
				<div class="text-center col-12 justify-content-center">
					<a href="" class="flat-btn-or text-uppercase">đăng ký ngay</a>
				</div>
			</div>
		</div> <!-- container -->
	</section> <!-- top-level -->
		...
		<div class="container">
	     	<div class="row">
		        <div class="text-center col-12 btn-gallery wow fadeInUp animated" data-wow-delay=".5s">
		            ...
		            <button class="btn btn-default filter-button" data-filter="psd">photoshop</button>
		            <button class="btn btn-default filter-button" data-filter="web">website</button>
		            <button class="btn btn-default filter-button" data-filter="business">business</button>
		            <button class="btn btn-default filter-button" data-filter="skills">skills</button>
		        </div>
						  	...
						  	<div class="box-card-block">
		            			<div class="card-block front-course">
							    	...
							    	<div class="pull-right price">
							    		<span><?php echo $course['course_price']; ?><sup>đ</sup></span>
							    	</div>
							    	<div class="clearfix"></div>
						  		</div>  <!-- card-block -->
		    ...
		    <div class="row">
		    	<div class="col-md-8 offset-md-2 text-center btn-group-c">
		    		<a href="#" class="flat-btn-or mt-4 text-uppercase">đăng ký ngay</a>
	            	<a href="#" class="flat-btn-b mt-4 ml-3 text-uppercase">xem thêm khóa khác</a>
		    	</div>
		    </div>
		...
		<div class="container mt-4">
			<div class="row">
				<div class="col-sm-6 col-md-3 mb-3 box-card">
					<div class="el-digital el-thumbnail">
						<div class="box-click text-white">
							<div class="box-img">
								<div class="image-column text-center">
									<div class="text-details">
				...
				<div class="col-sm-6 col-md-3 mb-3 box-card">
					<div class="el-frontend el-thumbnail">
						<div class="box-click text-white">
							<div class="box-img">
								<div class="image-column text-center">
									<div class="text-details">
										...
										<button type="button" class="Preview">
											<h4 class="text-white"><i class="fa fa-history text-white"></i> 50 giờ</h4>
										</button>
				...
				<div class="col-sm-6 col-md-3 mb-3 box-card">
					<div class="el-manager el-thumbnail">
						<div class="box-click text-white">
							<div class="box-img">
								<div class="image-column text-center">
									<div class="text-details">
										<h3>manager</h3>
										<button type="button" class="Preview">
											<h4 class="text-white"><i class="fa fa-history text-white"></i> 35 giờ</h4>
										</button>
				...
				<div class="col-sm-6 col-md-3 mb-3 box-card">
					<div class="el-window el-thumbnail">
						<div class="box-click text-white">
							<div class="box-img">
								<div class="image-column text-center">
									<div class="text-details">
										...
										<button type="button" class="Preview">
											<h4 class="text-white"><i class="fa fa-history text-white"></i> 60 giờ</h4>
										</button>
				...
				<div class="col-sm-6 col-md-3 mb-3 box-card">
					<div class="el-illustrator el-thumbnail">
						<div class="box-click text-white">
							<div class="box-img">
								<div class="image-column text-center">
									<div class="text-details">
										...
										<button type="button" class="Preview">
											<h4 class="text-white"><i class="fa fa-history text-white"></i> 20 giờ</h4>
										</button>
				...
				<div class="col-sm-6 col-md-3 mb-3 box-card">
					<div class="el-graphic el-thumbnail">
						<div class="box-click text-white">
							<div class="box-img">
								<div class="image-column text-center">
									<div class="text-details">
										...
										<button type="button" class="Preview">
											<h4 class="text-white"><i class="fa fa-history text-white"></i> 30 giờ</h4>
										</button>
				...
				<div class="col-sm-6 col-md-3 mb-3 box-card">
					<div class="el-security el-thumbnail">
						<div class="box-click text-white">
							<div class="box-img">
								<div class="image-column text-center">
									<div class="text-details">
				...
				<div class="col-sm-6 col-md-3 mb-3 box-card">
					<div class="el-project el-thumbnail">
						<div class="box-click text-white">
							<div class="box-img">
								<div class="image-column text-center">
									<div class="text-details">
										...
										<button type="button" class="Preview">
											<h4 class="text-white"><i class="fa fa-history text-white"></i> 45 giờ</h4>
										</button>
		...
		<div class="container mt-3">
			<div class="row">
				<div class="col-md-12 text-center">
						<a href="" class="text-center flat-btn-or mb-3">
							Xem tất cả các gói 
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6 offset-md-2">
					<input class="p-2" type="text" name="" placeholder="Email của bạn">
				</div>
				<div class="col-md-2">
					<input class="flat-btn-b btnsub" type="button" name="" value="Subcribe">
				</div>
			</div><!-- row -->
		</div><!-- container -->
	</section><!-- subcribe -->
              	...
              	success : function (response){
                    ...
                    response.forEach(function(object){
                    	// thêm thẻ option vào select với dữ liệu lấy từ database
					   	...
					   	//alert(object.day);
					   	var countDownDate = new Date(object.day).getTime();
	...
	<section class="list-courses p-5">
		...
		<div class="container">
	     	<div class="row">
	            	...
	            	<a href="">
		            	<div class="card">
		            		<div class="box-img">
						  	...
						  	<div class="box-card-block">
		            			<div class="card-block front-course">
							   	 	<h4 class="card-title">Learning Amazon Web Sevices Lambda</h4>
							    	<p class="card-text p-0 mb-2">Kirsten Hunter</p>
							    	<div class="p-0 pull-left">
							    		<i class="fa fa-star"></i>
								    	<i class="fa fa-star"></i>
								    	<i class="fa fa-star"></i>
							    	...
							    	<div class="pull-right price">
							    		<span>549.000<sup>đ</sup></span>
							    	</div>
							    	<div class="clearfix"></div>
						  		</div>  <!-- card-block -->
						  		<div class="card-block back-course">
						  			<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi tenetur consequatur, soluta. Aperiam, tempore rem enim tempora.</p>
						  		</div>
		            		</div> <!-- box-card-block -->
						</div>
					</a>
	            ...
	            <div class="gallery-product col-md-6 col-lg-3 filter web mb-c wow fadeInLeft animated" data-wow-delay=".75s">
					<a href="">
		            	<div class="card">
		            		<div class="box-img">
		            			<div class="hover-background text-center">
	            ...
	            <div class="gallery-product col-md-6 col-lg-3 filter skills wow fadeInLeft animated" data-wow-delay=".75s">
	            	<a href="">
		                <div class="card">
		            		<div class="box-img">
		            			<div class="hover-background text-center">
	            ...
	            <div class="gallery-product col-md-6 col-lg-3 filter business mt-c wow fadeInLeft animated" data-wow-delay=".75s">
	            	<a href="">
		                <div class="card">
		            		<div class="box-img">
		            			<div class="hover-background text-center">
	            ...
	            <div class="gallery-product col-md-6 col-lg-3 filter skills mt-c wow fadeInLeft animated" data-wow-delay=".75s">
	            	<a href="">
		                <div class="card">
		            		<div class="box-img">
		            			<div class="hover-background text-center">
	            	...
	            	<a href="">
		                <div class="card">
		            		<div class="box-img">
		            			...
		            			<img src="public/images/dev-7.jpg" class="img-fluid">
		            		</div>
						  	<div class="box-card-block">
		            			<div class="card-block front-course">
							   	 	<h4 class="card-title">Learning Amazon Web Sevices Lambda</h4>
	            	...
	            	<a href="">
		                <div class="card">
		            		<div class="box-img">
		            			...
		            			<img src="public/images/dev-8.jpg" class="img-fluid">
		            		</div>
						  	<div class="box-card-block">
		            			<div class="card-block front-course">
							   	 	<h4 class="card-title">Learning Amazon Web Sevices Lambda</h4>

		...
		<div class="container">
			<div class="row mb-5">
					...
					<a href="">
		            	<div class="card">
		            		<div class="box-img">
		            			...
		            			<img src="public/images/photoshop.jpg" class="img-fluid">
		            		</div>
						</div>
					</a>
	            </div>
				<div class="col-md-4 pl-5 pr-5 pt-5 pb-0 cart-info mt-3 mt-md-0">
					<div class="row">
						<div class="col-6">
							<span class="price mr-4 pr-2">559.000đ</span>
						</div>
						<div class="col-6">
			    	...
			    	<div class="clearfix"></div>
			    <div class="button-g">
			    	<a href="" class="mt-3 mb-3 flat-btn-or text-uppercase">
			    		<i class="fa fa-shopping-cart"></i>
			    		Mua khóa học
			    	</a>
			    	<a href="" class="mb-3 flat-btn-b pr-md-4 pr-4 pl-4 mt-2 text-uppercase">
					  			...
					  			<div class="col-md-12">
					  				<form>
						                <div class="form-group pt-4 pb-4 el-bk-b">
						                  <input type="text" class="form-control el-bk-btn" name="" value="" placeholder="Tìm kiếm cho khóa học này...">
						                  <i class="fa fa-search fa-lg" aria-hidden="true"></i>

						                </div>
						            </form>
					  				<p class="font-weight-bold pt-2 pb-1">Phần 1: Tổng quan về Photoshop CC</p>
		
					  				<div class="el_box_content_exercise">
					  					<p class="m-0">
						  					<i class="fa fa-lock pr-2"></i>
						  					Giới thiệu về Photoshop<br>
											<span class="pl-4">06:50</span>
						  				</p>
						  				<p class="m-0">
						  					<i class="fa fa-lock pr-2"></i>
						  					Cách mở, lưu 1 tập tin trong Photoshop<br>
											<span class="pl-4">06:50</span>
						  				</p>
						  				<p class="m-0">
						  					<i class="fa fa-lock pr-2"></i>
						  					Tìm hiểu về layer<br>
											<span class="pl-4">06:50</span>
						  				</p>
					  				</div>
					  		
					  				<p class="font-weight-bold pt-2 pb-1">Phần 2: Tìm hiểu các nhóm công cụ tool</p>
			...
			<div class="row comment mt-5">
				<div class="col-md-12">
					...
					<div class="row mb-3">
						...
						<div class="col-md-11">
							<div>
								<h6 class="font-weight-bold">Hoàng Lan - <span class="color999">hơn 1 năm trước</span></h6>
								...
								<p>Học mới thấy PTS cũng không khó lắm</p>
							</div>
						</div>
					</div>
					<div class="row mb-3">
						...
						<div class="col-md-11">
							<div>
								<h6 class="font-weight-bold">Linh Sâu - <span class="color999">hơn 1 năm trước</span></h6>
								<div class="el_box_icon_star">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
								...
								<p>Bài giảng dễ hiểu, cám ơn thầy giáo</p>
							</div>
						</div>
					</div>
					<div class="row mb-3">
						...
						<div class="col-md-11">
							<div>
								<h6 class="font-weight-bold">Phan Anh - <span class="color999">hơn 1 năm trước</span></h6>
								<div class="el_box_icon_star">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
								...
								<p>PTS thật ảo diệu, giờ tự thiết kế được banner rồi</p>
							</div>
						</div>
					</div>
				</div>

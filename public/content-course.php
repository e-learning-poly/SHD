    ...
    <div class="container">
      <div class="row">
                ...
                <div class="tab-pane pl-3 pr-3 pt-3" id="el_note" role="tabpanel">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <a href="" class="pull-right mt-3 mb-3 btn btn-primary mt-2 text-uppercase">
                        Lưu
                      </a>
                      <div class="clearfix"></div>
                      <div class="mt-4 mb-3">
              ...
              <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="form-group mt-4">
                      ...
                      <input type="button" class="btn btn-primary mt-2" value="Đánh giá">              
                  </form>
              </div>
        ...
        <div class="col-md-7 mt-4">
          <div class="gallery_product col-sm-12 col-12 filter skills list-courses p-0 mb-4">
             <div class="card">
              <div class="box-img">
                <a class="hover-background content-hover text-center">
                  <i class="fa fa-4x fa-play-circle-o"></i>
                  <p class="mt-2">Bắt đầu khóa học</p>
                </a>
                <img src="public/images/dev-4.jpg" class="img-fluid" width="100%">
              </div>
            </div>
          </div>
